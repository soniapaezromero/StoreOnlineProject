...
class __TwigTemplate_bc47d4de412015620cf6bbc2e3b7a45b extends Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"example-wrapper\">
        <h1>Hello ";
        // line 22
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape((isset($context["cliente"]) || array_key_exists("cliente", $context) ? $context["cliente"] : (function () { throw new RuntimeError('Variable "cliente" does not exist.', 22, $this->source); })()), "html", null, true);
        yield "</h1>

        <p>This is dasboard del carpeta user.</p>
    </div>
    <a href=\"";
        // line 26
...
";
    ...
    {
        return array (  138 => 26,  131 => 22,  123 => 16,  117 => 15,  105 => 9,  100 => 8,  95 => 7,  90 => 6,  80 => 5,  60 => 3,  37 => 1,);
    }
...
{% block title %}Hello Cliente{% endblock %}
...
{% block body %}
    ...
    <a href=\"{{ path('app_login') }}\">LogOut</a>
{% endblock %}", "user/dashboard.html.twig", "C:\\xampp\\htdocs\\StoreOnlineProject-master\\templates\\user\\dashboard.html.twig");
    }
}
